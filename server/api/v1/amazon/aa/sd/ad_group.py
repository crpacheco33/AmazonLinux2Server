...
async def show(
    ...
    log.info(
        f'Showing SD ad group {ad_group_id}...',
    )
    ...
    log.info(
        f'Showed SD ad group {ad_group_id}',
    )
...
async def update(
    request: Request,
    data: List[UpdateSDAdGroupSchema],
    brand: Any = Depends(
        brand,
    ),
    interface: Interface = Depends(
...
async def destroy(
    ...
    log.info(
        f'Archiving SD ad group {ad_group_id}...',
    )
    ...
    log.info(
        f'Archived SD ad group {ad_group_id}',
    )
