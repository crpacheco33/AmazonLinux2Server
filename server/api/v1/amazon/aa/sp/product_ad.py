...
async def show(
    ...
    log.info(
        f'Showing SP product ad {product_ad_id}...',
    )
    ...
    log.info(
        f'Showed SP product ad {product_ad_id}',
    )
...
async def update(
    request: Request,
    data: List[UpdateSPProductAdSchema],
    brand: Any = Depends(
        brand,
    ),
    interface: Interface = Depends(
    ...
    product_ads = []
    product_ad_ids = [product_ad.get('adId') for product_ad in response]
...
async def destroy(
    ...
    log.info(
        f'Archiving SP product ad {product_ad_id}...',
    )
    ...
    log.info(
        f'Archived SP product ad {product_ad_id}',
    )
