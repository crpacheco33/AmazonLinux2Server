...
async def show(
    ...
    log.info(
        f'Showing SP keyword {keyword_id}...',
    )
    ...
    log.info(
        f'Showed SP keyword {keyword_id}',
    )
...
async def update(
    request: Request,
    data: List[UpdateSPKeywordSchema],
    brand: Any = Depends(
        brand,
    ),
    interface: Interface = Depends(
    ...
    request = Request(
        scope={
            ...
            'path': '/api/v1/amazon/aa/sp/keywords',
            'query_string': b'',
            'type': 'http',
        }
    )
...
async def destroy(
    ...
    log.info(
        f'Archiving SP keyword {keyword_id}...',
    )
    ...
    log.info(
        f'Archived SP keyword {keyword_id}',
    )
