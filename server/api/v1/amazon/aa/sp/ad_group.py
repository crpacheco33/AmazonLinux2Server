...
async def show(
    ...
    log.info(
        f'Showing SP ad group {ad_group_id}...',
    )
    ...
    log.info(
        f'Showed SP ad group {ad_group_id}',
    )
...
async def update(
    request: Request,
    data: List[UpdateSPAdGroupSchema],
    brand: Any = Depends(
        brand,
    ),
    interface: Interface = Depends(
...
async def destroy(
    ...
    log.info(
        f'Archiving SP ad group {ad_group_id}...',
    )
    ...
    log.info(
        f'Archived SP ad group {ad_group_id}',
    )
